...
const AppointmentBanner = ({ date, setDate }) => {
    ...
    return (
        <div
            ...
            className="hero lg:py-10 md:py-5 sm:py-5 lg:px-8 md:px-8 sm:px-7 px-0 mb-10">
            <div style={{ maxWidth: '85rem' }} className="hero-content  flex-col lg:flex-row-reverse ">
                <img style={{ width: '100%' }} src={chair} className="lg:max-w-lg  rounded-lg shadow-2xl  lg:mr-3" alt='Dentist chair' />
